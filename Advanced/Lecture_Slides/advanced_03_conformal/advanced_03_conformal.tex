...
\begin{frame}{What Chapter 3 gave us --- and what it silently assumed}
  ...
  \begin{numexample}[Wage breaks the fine print]
    ...
    $66.2$ --- and covers $95.2\%$ of test wages while \emph{claiming} 90\%:
...
\begin{frame}{Wage: the calibration quantile and the band it buys}
  ...
  \begin{takeaway}
    ...
    Gaussian band ($\pm 66.2$, covering $95.2\%$).
  \end{takeaway}
...
\begin{frame}{Pitfall 1: exchangeability violations in the wild}
  \begin{itemize}
    \item \textbf{Time series}: calibration residuals from 2019--2024, deployment in
          2026 --- trends, seasonality and regime shifts make the test point
