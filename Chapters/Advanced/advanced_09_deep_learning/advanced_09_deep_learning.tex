...
\begin{frame}{What's next}
  This is the last taught chapter. The optional self-study module
  \textbf{A7 --- Multiple Testing} (ISLP Chapter 13, in
  \texttt{Chapters/Advanced/}) picks up from here:
  \begin{itemize}
...
\begin{frame}{Appendix --- what is in here, and why}
  ...
  \begin{block}{Contents of the appendix}
    \begin{itemize}
      ...
      \item \textbf{Convolutional networks (CNNs)} --- convolution, pooling, a full architecture, and Exercise 10.4 on layer arithmetic. The ideas carry over from the MLP, so the taught session spends its time on training instead; read this block when you work with images.
