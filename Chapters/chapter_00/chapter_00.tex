...
\begin{frame}{Quantiles, the five-number summary, and the boxplot}
  ...
  \begin{labnote}[Companion notebook]
    ...
    \S2 \emph{Describing one variable: centre, spread, shape}, with
    \texttt{df["wage"].describe()}.
  \end{labnote}
\end{frame}
...
\end{lstlisting}
  ...
  \begin{labnote}[Companion notebook]
    ...
    \S8 \emph{Simple linear regression --- the bridge into Chapter 3}.
  \end{labnote}
\end{frame}
...
\begin{frame}{Where to read more}
  ...
  \begin{labnote}[Practice beats reading]
    ...
    reproduce them in Python in \texttt{Lab\_Notebooks/chapter\_00\_lab.ipynb}
