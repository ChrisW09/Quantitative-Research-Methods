...
\begin{frame}{The course at a glance}
  ...
  \begin{tabular}{@{\hspace{2pt}}r l >{\raggedright\arraybackslash}p{0.60\textwidth}@{\hspace{2pt}}}
    \toprule
    \textbf{Lecture} & \textbf{Chapter} & \textbf{Topic} \\
    \midrule
    \rowcolor{accent!18} \textbf{Pre} & \textbf{Ch.\ 0 + 0b} & \textbf{Statistics refresher and the toolkit}\,{\color{accent!75!black}--- one taught session} \\
    \rowcolor{black!3} 1 & {\color{accent}Ch.\ 1 + 2} & Introduction\,{\color{black!45}--- what is statistical learning} \\
     2 & {\color{accent}Ch.\ 2} & Assessing model accuracy\,{\color{black!45}--- bias--variance, Bayes classifier, KNN} \\
    \rowcolor{black!3} 3--4 & {\color{accent}Ch.\ 3} & Linear regression\,{\color{black!45}--- estimation, inference, diagnostics} \\
     5--6 & {\color{accent}Ch.\ 4} & Classification\,{\color{black!45}--- logistic regression, confusion matrix, ROC} \\
    \rowcolor{black!3} 7 & {\color{accent}Ch.\ 5} & Resampling\,{\color{black!45}--- validation, CV, bootstrap} \\
     8 & {\color{accent}Ch.\ 6} & Model selection and regularisation\,{\color{black!45}--- ridge, lasso} \\
    \rowcolor{black!3} 9 & {\color{accent}Ch.\ 7} & Moving beyond linearity\,{\color{black!45}--- splines, GAMs} \\
     10 & {\color{accent}Ch.\ 8} & Tree-based methods\,{\color{black!45}--- trees, forests, boosting} \\
    \rowcolor{black!3} 11 & {\color{accent}Ch.\ 9} & Support vector machines \\
     12 & {\color{accent}Ch.\ 10} & Deep learning\,{\color{black!45}--- MLPs, CNNs, training} \\
    \rowcolor{black!3} 13 & {\color{accent}Ch.\ 11} & Survival analysis\,{\color{black!45}--- censored data} \\
     14 & {\color{accent}Ch.\ 12} & Unsupervised learning\,{\color{black!45}--- PCA, clustering} \\
    \rowcolor{black!3} 15 & {\color{accent}Ch.\ 13} & Multiple testing\,{\color{black!45}--- FWER, FDR} \\
    \bottomrule
  \end{tabular}
  \end{center}
  \vspace{1mm}
  {\scriptsize The precourse is taught in one 180-minute session drawing on both decks, before Lecture 1; the fifteen lectures follow. It assumes nothing beyond an introductory undergraduate course. Today's session is highlighted.}
\end{frame}
