...
\begin{frame}{Where this chapter is used in industry}
  ...
  \begin{tabular}{@{}p{2.3cm}p{4.7cm}p{5.4cm}@{}}
    ...
    E-commerce & Online A/B test of a checkout or ranking change, sized in
      advance for the smallest lift worth having &
  ...
  \end{tabular}
  \end{center}
  \begin{takeaway}[All three turn a sample into a yes/no call]
    Every row is the same two-step move: \emph{describe} what the sample
    shows, then quantify \emph{how much of it could be noise}. The decision
    hangs on the second step --- the first one alone never settles it.
  \end{takeaway}
\end{frame}
