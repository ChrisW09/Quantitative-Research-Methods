...
\begin{frame}{The course at a glance}
  ...
  \begin{tabular}{@{}c r l@{}}
    ...
    \midrule
    $\blacktriangleright$ & \textbf{Precourse} & \textbf{Ch.\ 0 + 0b --- statistics refresher and the toolkit (one session)} \\
  ...
  \end{center}
  \vspace{2pt}
  {\scriptsize The precourse is taught in one 180-minute session drawing on both decks, before Lecture 1; the fifteen lectures follow. It assumes nothing beyond an introductory undergraduate course. $\blacktriangleright$ marks today's session.}
\end{frame}
