...
\begin{frame}{What's next}
  ...
  \begin{labnote}[Companion notebook]
    ...
    deck: the logit conversions (\S3), a likelihood maximised by hand and by
    \texttt{scipy} (\S4), the $2^p$ count (\S5), and a complete
    split/fit/score experiment on \texttt{Auto} (\S6,
    \emph{The Python patterns every lab uses}).
  \end{labnote}
\end{frame}
