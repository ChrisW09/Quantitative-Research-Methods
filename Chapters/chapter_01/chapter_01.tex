...
df.describe()      # summary statistics for every column
  \end{lstlisting}
  \begin{labnote}[{{Live demo --- \S1 of the notebook}}]
    These calls run for real in \texttt{chapter\_01\_lab.ipynb} \S1: \texttt{Wage.describe(include='all').T} shows which columns are numeric and which categorical --- e.g.\ mean age $42.4$, top education level \emph{2.\ HS Grad} (971 of $3\,000$).
  \end{labnote}
\end{frame}
