...
\begin{frame}{Self-check questions}
  \begin{enumerate}
    \item Sketch the bias-variance decomposition curves. Where is the
          optimal flexibility? (p.~57)
    \item Why is the irreducible error not a function of $\hat f$? (p.~13)
    \item Construct an example where a more flexible method is
          preferable to a linear model. (pp.~22 and 95--97)
    \item For KNN, what happens to bias and variance as $K$ grows? (p.~77)
