...
\begin{frame}{The course at a glance}
  ...
  \begin{tabular}{@{\hspace{2pt}}r l >{\raggedright\arraybackslash}p{0.60\textwidth}@{\hspace{2pt}}}
    ...
    \rowcolor{accent!18} \textbf{3--4} & \textbf{Ch.\ 3} & \textbf{Linear regression}\,{\color{accent!75!black}--- estimation, inference, diagnostics} \\
    \rowcolor{black!3} 5--6 & {\color{accent}Ch.\ 4} & Classification\,{\color{black!45}--- logistic regression, confusion matrix, ROC} \\
