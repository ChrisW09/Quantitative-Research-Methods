...
\begin{frame}{Confidence band vs.\ prediction band, on Auto}
  \begin{center}
...
\begin{frame}{Why Advertising needs an interaction}
  \begin{center}
...
\begin{frame}{Self-check questions}
  \begin{enumerate}
    \item Derive the OLS slope $\hat\beta_1$ from the normal equations.
          (pp.~24--25; in full in the appendix, pp.~147--149)
