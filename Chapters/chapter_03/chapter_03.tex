...
\begin{frame}{Where this chapter is used in industry}
  ...
  \end{tabular}
  \end{center}
  \begin{takeaway}[All three deliver a coefficient --- not a prediction]
    Nobody in these rows wants a forecast: they want one number, read off one
    predictor, that someone then has to defend in a meeting. That is why
    standard errors, intervals and diagnostics matter here as much as the fit.
  \end{takeaway}
\end{frame}
