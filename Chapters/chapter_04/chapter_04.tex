...
\begin{frame}{Why we need a logistic curve}
  ...
  \end{takeaway}
  \par{\tiny\itshape\color{gray}History: Verhulst (1838) introduced the curve
  for population growth; Berkson (1944) the logit; Cox (1958) the regression.}
\end{frame}
...
\begin{frame}{Linear Discriminant Analysis: the assumption}\label{frm:ldaassume}
  ...
  \begin{takeaway}[Why this assumption is interesting]
    ...
    design.
  \end{takeaway}
  \par{\tiny\itshape\color{gray}History: LDA is R.~A.\ Fisher's (1936); the
  same paper made Edgar Anderson's iris flower data the classic demo data set
  of machine learning.}
\end{frame}
