...
print("95%:", np.quantile(boots, [0.025, 0.975]))  # percentile CI
  ...
  \begin{labnote}[{{Live demo --- \S5 of the notebook}}]
    Run the bootstrap cells in \S5: $B = 1000$ resampled slopes of
    \texttt{mpg}$\sim$\texttt{horsepower} give $\widehat{\mathrm{SE}} = 0.0075$
    against the OLS formula's $0.0064$, and the histogram cell shows the whole
