...
\begin{frame}{The course at a glance}
  ...
  \begin{tabular}{@{\hspace{2pt}}r l >{\raggedright\arraybackslash}p{0.60\textwidth}@{\hspace{2pt}}}
    ...
    \rowcolor{accent!18} \textbf{8} & \textbf{Ch.\ 6} & \textbf{Model selection and regularisation}\,{\color{accent!75!black}--- ridge, lasso} \\
...
\begin{frame}[fragile]{Extended Exercise 6.3 --- CV Ridge and Lasso Test MSE on Hitters [Python]}
  \begin{longexercise}
    ...
    \end{enumerate}
  \end{longexercise}
  \begin{labnote}[Run this live: \emph{Lecture exercises --- worked Python solutions}]
    The runnable solution, with the printed numbers, is the second entry of that
    notebook section, headed \emph{Extended Exercise 6.3} to match this deck.
  \end{labnote}
\end{frame}
