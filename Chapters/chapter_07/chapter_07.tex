...
\begin{frame}{The truncated-power basis, drawn}
  ...
  \end{center}
  \begin{takeaway}
    Exercise 7.3's count, drawn: four global polynomial terms plus one
    truncated cubic per knot ($K=3$ knots at the Wage age quartiles) $=$
    $K+4=7$ basis functions. Each truncated term is \emph{zero left of its
    knot} --- that locality is what a polynomial can never have.
  \end{takeaway}
\end{frame}
