...
\begin{frame}{The course at a glance}
  ...
  \begin{tabular}{@{\hspace{2pt}}r l >{\raggedright\arraybackslash}p{0.60\textwidth}@{\hspace{2pt}}}
    ...
    \rowcolor{accent!18} \textbf{9} & \textbf{Ch.\ 7} & \textbf{Moving beyond linearity}\,{\color{accent!75!black}--- splines, GAMs} \\
...
\end{longexercise}
\begin{labnote}[Run this live: \emph{Extended Exercise 7.3 --- Three fits for wage vs.\ age}]
Under \emph{Lecture exercises --- worked Python solutions} in \texttt{chapter\_07\_lab.ipynb}: the nested ANOVA, the three fits and the overlay plot, ready to run.
\end{labnote}
\end{frame}
