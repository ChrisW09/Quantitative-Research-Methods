...
\begin{frame}{The course at a glance}
  ...
  \begin{tabular}{@{\hspace{2pt}}r l >{\raggedright\arraybackslash}p{0.60\textwidth}@{\hspace{2pt}}}
    ...
    \rowcolor{accent!18} \textbf{12} & \textbf{Ch.\ 10} & \textbf{Deep learning}\,{\color{accent!75!black}--- MLPs, CNNs, training} \\
...
\begin{frame}{Python lab --- run it live in the notebook}
  \begin{labnote}[Companion notebook: \texttt{chapter\_10\_lab.ipynb}]
    ...
    \end{itemize}
    Requires \texttt{torch}; \S4, \emph{Exercises} ends the notebook with hands-on tasks.
  \end{labnote}
\end{frame}
