...
\subtitle{Chapter 11: Survival Analysis and Censored Data}
...
\begin{frame}{The course at a glance}
  ...
  \begin{tabular}{@{\hspace{2pt}}r l >{\raggedright\arraybackslash}p{0.60\textwidth}@{\hspace{2pt}}}
    ...
    \rowcolor{accent!18} \textbf{13} & \textbf{Ch.\ 11} & \textbf{Survival analysis}\,{\color{accent!75!black}--- censored data} \\
