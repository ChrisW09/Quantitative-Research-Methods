...
\begin{frame}{When to standardise, and when not to}
  ...
  \end{mistake}
  \begin{labnote}
    \S1 of \texttt{chapter\_12\_lab.ipynb} runs both versions side by side and prints both PVE
...
\begin{frame}{PCA when $p \gg n$: 1000 genes, 40 samples}
  ...
  \begin{labnote}[{{Live demo --- \S4 of the notebook}}]
    Switch to \texttt{chapter\_12\_lab.ipynb} \S4: $\mathrm{PVE}_1=0.127$, PC1 group means $\pm 11.75$.
  \end{labnote}
\end{frame}
...
\begin{frame}{USArrests at $K=2$, $3$ and $4$}
  ...
  \begin{labnote}[{{Live demo --- \S2 of the notebook}}]
    Switch to \texttt{chapter\_12\_lab.ipynb} \S2 and run the $K$-loop cell: $W = 200.0,\ 105.0,\ 79.9,\ 57.6$.
  \end{labnote}
\end{frame}
...
\begin{frame}{Cutting the tree chooses $K$ --- after you have seen it}
  ...
  \begin{labnote}[{{Live demo --- \S3 of the notebook}}]
    Switch to \texttt{chapter\_12\_lab.ipynb} \S3 and cut the tree: sizes $(31,19)$ and $(31,11,8)$.
  \end{labnote}
\end{frame}
...
\begin{frame}{The decisions you must make, and must report}
  ...
  \begin{labnote}[{{Live demo --- \S5 of the notebook}}]
    Switch to \texttt{chapter\_12\_lab.ipynb} \S5: noise silhouette $0.323$, bootstrap ARI $0.68$.
  \end{labnote}
\end{frame}
