...
\begin{frame}{The course at a glance}
  ...
  \begin{tabular}{@{\hspace{2pt}}r l >{\raggedright\arraybackslash}p{0.60\textwidth}@{\hspace{2pt}}}
    ...
    \rowcolor{accent!18} \textbf{15} & \textbf{Ch.\ 13} & \textbf{Multiple testing}\,{\color{accent!75!black}--- FWER, FDR} \\
    \bottomrule
  \end{tabular}
  \end{center}
  \vspace{1mm}
...
\begin{labnote}[Run this live]
  The worked solution sits in \texttt{chapter\_13\_lab.ipynb} under
