...
\begin{frame}{Solution --- Exercise 0.4}
  \begin{solutionbox}
    ...
    $f \le 0.0048$ --- below \textbf{0.48\%}, four times stricter than today's
    $2\%$ and reachable only by flagging less aggressively, which costs
    detection: the ROC trade-off of Chapter 4.
  \end{solutionbox}
\end{frame}
