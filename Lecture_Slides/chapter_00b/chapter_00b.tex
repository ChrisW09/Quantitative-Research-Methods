...
\begin{frame}{Where this chapter is used in industry}
  ...
  \begin{tabular}{@{}p{2.3cm}p{4.8cm}p{5.3cm}@{}}
    ...
    Banking & Credit scorecards and probability-of-default models, built on
      the log-odds scale &
      A cut-off score: approve, refer or decline, and at what price \\
    Retail / airlines & Log--log demand models, whose coefficient \emph{is}
      the price elasticity &
      How far a price can move, and what it does to revenue \\
    ...
    Finance & Continuously compounded log returns; CAGR &
      Returns that add up over time --- performance and volatility reporting \\
    Telco / SaaS & Retention curves that decay roughly exponentially &
      Expected customer lifetime, hence acquisition budget and lifetime value \\
    \bottomrule
  \end{tabular}
  \end{center}
...
\begin{frame}{Why logs are everywhere in statistics}
  ...
  \end{numexample}
  \begin{industry}[Finance and pricing]\scriptsize
...
\begin{frame}{The three scales, drawn}
  ...
  probability.
  \begin{industry}[Betting and insurance quote odds --- not probabilities]\scriptsize
