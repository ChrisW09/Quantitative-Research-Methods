...
\begin{frame}{What is statistical learning?}
  ...
  \begin{readme}
    ...
    \end{itemize}
  \end{readme}
  \begin{industry}[Which half a firm's questions fall into]
...
\begin{frame}{Three motivating examples set the tone}
  ...
  \begin{takeaway}
    ...
    \end{itemize}
  \end{takeaway}
  \begin{industry}[The same three flavours at work]
...
\begin{frame}{Why Python?}
  ...
  \begin{readme}
    ...
    throughout.
  \end{readme}
  \begin{industry}[The production stack --- not just the teaching stack]
...
\begin{frame}{Datasets used throughout the book}
  ...
  \begin{takeaway}
    ...
    laptop in seconds.
  \end{takeaway}
  \begin{industry}[Why company data never arrives this tidy]
...
\begin{frame}{Pitfalls to remember from day one}
  \begin{alertblock}{The classic mistakes}
    ...
    \end{enumerate}
  \end{alertblock}
  \begin{industry}[What actually kills a model project in a firm]
