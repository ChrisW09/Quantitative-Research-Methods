...
\begin{frame}{Where this chapter is used in industry}
  ...
  \begin{tabular}{@{}p{2.2cm}p{6.0cm}p{5.0cm}@{}}
    \toprule
    \textbf{Sector} & \textbf{Concrete application} & \textbf{What the method delivers} \\
    \midrule
  ...
  \end{tabular}
  \end{center}
  \begin{takeaway}[The common thread]
...
\begin{frame}{Worked example: prediction goal}
  \begin{numexample}[Direct-mail marketing]
    ...
    \end{itemize}
  \end{numexample}
  \begin{industry}[Telco / SaaS: churn scoring]
...
\begin{frame}{Training MSE vs.\ test MSE}
  ...
  \begin{alertblock}{The cardinal sin}
    ...
    itself.
  \end{alertblock}
  \begin{industry}[Buying a model from a vendor]
...
\begin{frame}{Bias and variance trade off}
  ...
  \end{itemize}
  \begin{industry}[Low signal-to-noise: why parsimony wins]
...
\begin{frame}{Choosing $K$ in practice}
  \begin{takeaway}[Practical advice]
    ...
    \end{itemize}
  \end{takeaway}
  \begin{industry}[Where nearest neighbours actually run]
