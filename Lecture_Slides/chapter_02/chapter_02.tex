...
\subtitle{Chapter 2: Statistical Learning \textemdash{} Improved Edition}
...
\begin{frame}{Conditional class probabilities}
  ...
  \begin{takeaway}
    ...
    Logistic regression, LDA/QDA, naive Bayes, KNN, trees, RF, NNs
...
\begin{enumerate}\setlength\itemsep{1pt}
  ...
  \item For $K=1,2,\ldots,50$ fit a $K$-NN classifier and record the \emph{training} and \emph{test} error rates.
...
\begin{enumerate}\setlength\itemsep{1pt}
  \item \textbf{KNN regression by hand.} List the distances $|x_i-x_0|$; predict $\hat y(x_0)$ for $K=1$ and $K=3$ (a $K$-NN regressor \emph{averages} the $K$ nearest responses).
...
\begin{frame}{Vocabulary checklist}
  ...
  \begin{tabular}{ll}
    ...
    Bias / variance / Bayes error & Three parts of expected test MSE \\
