...
\begin{frame}{Industry case in depth: marketing mix modelling (MMM)}
  ...
  \begin{columns}[T]
    ...
    \end{column}
    \begin{column}{0.49\textwidth}
      \begin{readme}[What the output is used for --- and who signs it off]
...
\begin{frame}{Solution --- Extended Exercise 3.L1 (3/3)}
  \begin{solutionbox}
    ...
    \medskip
    \textit{Common mistake:} dropping the ``$1+$'' under the root. That
...
\begin{frame}{Solution --- Exercise 3.5}
  \begin{solutionbox}
    ...
    \smallskip
    \textit{Common mistake:} concluding ``newspaper advertising cannot
...
\begin{frame}{Solution --- Exercise 3.6}
  \begin{solutionbox}
    ...
    \medskip
    \textit{Common mistake:} reading the significant $F$ as ``all three
...
\end{lstlisting}
    ...
    \smallskip
    \textit{Common mistake:} citing the unchanged $R^2$ as the evidence.
...
\begin{frame}{Solution --- Extended Exercise 3.L4 (2/2)}
  \begin{solutionbox}
    ...
    \smallskip
    \textit{Common mistake:} reading $\hat\beta_4=2$ as the South's
...
\begin{frame}{Solution --- Exercise 3.10}
  \begin{solutionbox}
    ...
    \smallskip
    \textit{Common mistake:} judging these assumptions from the raw
...
\begin{frame}{Outliers and leverage: visual examples}
  ...
  \end{center}
  Left: point 41 has an extreme $x$ and drags the fit (red) away from the fit
  without it (blue); point 20 is unusual in $y$ only. Middle: 41 is
...
\begin{frame}{Solution --- Extended Exercise 3.L5 (2/2)}
  \begin{solutionbox}
    ...
    \smallskip
    \textit{Common mistake:} conflating the diagnoses --- an outlier is
...
\begin{frame}{Solution --- Extended Exercise 3.L6 (3/3)}
  \begin{solutionbox}
    ...
    \smallskip
    \textit{Common mistake:} choosing $K$ by training MSE --- it falls
