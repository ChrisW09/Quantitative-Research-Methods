...
\begin{frame}{Industry case in depth: credit scoring (probability of default)}
  \footnotesize
  \begin{readme}[The model behind an accept/decline decision]
  ...
  \end{numexample}
  \begin{industry}[Which decision --- and who signs off]
...
\begin{frame}{Method comparison: when each wins}
  ...
  \end{takeaway}
  \begin{industry}[How the comparison is actually reported]
    ...
    that is where the budget goes. Boosted trees (Ch.~8) often win outright ---
