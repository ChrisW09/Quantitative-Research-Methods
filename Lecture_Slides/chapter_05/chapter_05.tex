...
\subtitle{Chapter 5: Resampling Methods \textemdash{} Improved Edition}
...
\begin{frame}{Learning objectives for this chapter}
  ...
  \begin{itemize}
    ...
    \item \textbf{Avoid} the common resampling pitfalls (information
          leakage, time-series CV, group-respecting splits).
  \end{itemize}
\end{frame}
...
\begin{frame}{Why training error is the wrong answer}
  ...
  error therefore underestimates how well the model would do on new
...
\begin{frame}{The bootstrap algorithm}
  \begin{block}{Recipe}
    \begin{enumerate}
      ...
      \item Estimate the standard error by:
            \[
...
\begin{frame}{The bootstrap in action: the sampling distribution of $\hat\alpha$}
  \begin{center}\includegraphics[width=0.88\textwidth,height=0.56\textheight,keepaspectratio]{ch05_x_bootstrap_alpha_hist.png}\end{center}
...
\begin{frame}{Connections to the rest of the course}
  \begin{itemize}
    ...
    \item Ch.~9, 10: tune $C$, $\gamma$, learning rate, dropout via CV.
