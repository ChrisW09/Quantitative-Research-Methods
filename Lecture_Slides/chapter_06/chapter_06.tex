...
\begin{frame}{Choose $\lambda$ by cross-validation}
  ...
  \end{readme}
  \begin{industry}[Wide SKU and customer feature tables]
...
\begin{frame}{The high-dimensional regime}
  ...
  \end{takeaway}
  \begin{industry}[Biomarker screening and health economics]
