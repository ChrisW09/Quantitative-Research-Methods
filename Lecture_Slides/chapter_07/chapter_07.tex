...
\begin{frame}{Industry case in depth: pricing a motor insurance policy}
  ...
  \begin{readme}[What the fitted age curve looks like]
    It is famously \emph{non-monotone}: risk is high for the youngest drivers, falls through middle age, then rises again for the oldest. A linear term in age cannot represent that shape at all --- a smooth can, and still prints as one readable curve.
  \end{readme}
