...
\begin{frame}{Where this chapter is used in industry}
  ...
  \begin{tabular}{@{}p{2.5cm}p{5.5cm}p{4.7cm}@{}}
    \toprule
    \textbf{Sector} & \textbf{Concrete application} & \textbf{What the smooth fit delivers} \\
    \midrule
    Motor \& health insurance & Claim frequency and severity as smooth functions of driver age, vehicle age, mileage & The risk curve that enters the technical tariff \\
    ...
    Banking --- fixed income & Yield curves fitted to quoted bond yields (cubic splines, Nelson--Siegel--Svensson) & The discount curve used to value and hedge the book \\
...
\begin{frame}{Why GAMs are so useful}
  ...
  \end{alertblock}
  \begin{industry}[Why regulated industries reach for GAMs]
