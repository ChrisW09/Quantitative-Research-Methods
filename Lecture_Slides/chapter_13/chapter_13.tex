...
\begin{frame}{Where this chapter is used in industry}
  ...
  \begin{tabular}{@{}p{2.6cm}p{5.2cm}p{4.6cm}@{}}
    ...
    Model risk & Fairness and drift tests across many subgroups and metrics &
      Which gaps are real enough to act on \\
    \bottomrule
  \end{tabular}
  \end{center}
...
\begin{frame}{FDR vs.\ FWER: which to use?}
  \begin{readme}
    ...
    \end{itemize}
  \end{readme}
  \begin{industry}[The business version of the same question]
