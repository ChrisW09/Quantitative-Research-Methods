...
\begin{frame}{Problem 3 --- task}
  \begin{exercise}[Problem 3 (20 P) --- Trees by hand]
    ...
    (b) \textbf{[2 P]} Prediction for a new branch with $x=5$.
...
\begin{frame}{Problem 6 --- task}
  \begin{exercise}[Problem 6 (20 P) --- Multiple testing]
    \begin{itemize}
      ...
      \item[(c)] \textbf{[6 P]} Benjamini--Hochberg at $q=0.10$ on the same $p$-values:
...
\begin{frame}{Problem 7 --- task}
  \begin{exercise}[Problem 7 (20 P) --- Cumulative essentials]
    \begin{itemize}
      ...
      \item[(b)] \textbf{[4 P]} Logistic regression for passing an exam: $\hat\beta_1=0.8$ for
        hours studied ($e^{0.8}=2.226$): effect of one more study hour on the \emph{odds}; why is
...
\begin{frame}{Problem 7 --- solution (a) to (c)}
  \begin{solutionbox}[Solution P7 --- (a) to (c)]
    ...
    \textbf{(b)} One more study hour adds $0.8$ to the log-odds, i.e.\ \emph{multiplies}
    the odds of passing by $e^{0.8}=\mathbf{2.226}$ (about $+123\%$) --- the same factor at
