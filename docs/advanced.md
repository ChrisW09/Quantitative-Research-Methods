...
myst:
  html_meta:
    description: "Seven optional advanced modules extending the course — randomised controlled trials, Shapley-value explanations, conformal prediction, GLMs with penalized splines, support vector machines, survival analysis and multiple testing — each with a full lecture deck and a companion notebook."
---

# Advanced modules

{.qrm-lead}
Seven optional, self-study modules. Four take the course beyond ISLP: causal
...
exponential-family machinery that unifies GLMs and penalized splines. Three more
are ISLP chapters lifted out of the taught sequence — support vector machines
(Ch 9), survival analysis (Ch 11) and multiple testing (Ch 13).

:::{container} qrm-chips
[**7** modules]{.qrm-chip}
[**562** slides]{.qrm-chip}
[**44 + 17** exercises with solutions]{.qrm-chip}
[**7** companion notebooks]{.qrm-chip}
