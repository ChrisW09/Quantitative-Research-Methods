...
| A8 | Unsupervised Learning | No test error to validate against, principal components (loadings, scores, PVE, the biplot), the scaling decision, *K*-means and its local optima, dendrograms, linkage and dissimilarity, clusters in pure noise | 100 | <a href="slides/advanced_08_unsupervised.pdf">Open</a> | [Rendered](advanced_labs/advanced_08_unsupervised_lab) | [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/ChrisW09/Quantitative-Research-Methods/blob/main/Chapters/Advanced/advanced_08_unsupervised/advanced_08_unsupervised_lab.ipynb) |
