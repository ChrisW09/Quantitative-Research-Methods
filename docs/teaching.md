...
|---|---|:--:|
| `semester_plan.md` | The thirteen weeks on one page: what to teach when, where the three split lectures break, what to sacrifice when you fall behind | [open](https://github.com/ChrisW09/Quantitative-Research-Methods/blob/main/Teaching_Guide/semester_plan.md) |
